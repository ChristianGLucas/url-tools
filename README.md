...
https://dev.axiomide.com/marketplace/christiangeorgelucas/url-tools@0.1.1
...
```bash
axiom invoke christiangeorgelucas/url-tools/ParseUrl --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/url-tools/0.1.1/ParseUrl \
...
> `axiom inspect node christiangeorgelucas/url-tools/ParseUrl`.
